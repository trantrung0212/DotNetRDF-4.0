...
namespace VDS.RDF.Parsing.Events
{
    ...
    /// </summary>
    public class RootEvent : BaseEvent
    {
    ...
    /// </summary>
    public class ElementEvent : BaseEvent 
    {
    ...
    /// </summary>
    public class EndElementEvent : BaseEvent
    {
        /// <summary>
    ...
    /// </summary>
    public class NamespaceAttributeEvent : BaseEvent
    {
    ...
    /// </summary>
    public class LanguageAttributeEvent : BaseEvent
    {
    ...
    /// </summary>
    public class ParseTypeAttributeEvent : BaseEvent
    {
    ...
    /// </summary>
    public class XmlBaseAttributeEvent : BaseEvent
    {
    ...
    /// </summary>
    public class UriReferenceEvent : BaseEvent
    {
        private String _id;
    ...
    /// </summary>
    public class QNameEvent : BaseEvent
    {
    ...
    /// </summary>
    public class BlankNodeIDEvent : BaseEvent
    {
        private String _id;
    ...
    /// </summary>
    public class PlainLiteralEvent : BaseEvent
    {
        private String _value;
    ...
    /// </summary>
    public class TypedLiteralEvent : BaseEvent
    {
        private String _value;
    ...
    /// </summary>
    internal class ClearQueueEvent : BaseEvent
    {
        /// <summary>
        /// Creates a new Clear Queue Event
        /// </summary>
        public ClearQueueEvent()
            : base(Event.Clear, String.Empty) { }
    }
}