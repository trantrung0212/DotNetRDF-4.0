...
namespace VDS.RDF
{
        ...
        where T : class
    {
        ...
        public ThreadSafeReference(Func<T> init)
        {
            this._init = init;
        }
        ...
        where T : struct
    {
        ...
        /// </summary>
        /// <param name="init">Initialiser Function</param>
        public ThreadSafeValue(Func<T> init)
        {
            this._init = init;
        }
