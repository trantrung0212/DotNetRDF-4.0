...
namespace VDS.RDF.Query.Expressions.Functions
{
    ...
    public class MD5HashFunction : LeviathanMD5HashFunction
    {
        ...
        {
            get { return SparqlSpecsHelper.SparqlKeywordMD5; }
        }
        ...
        {
            return SparqlSpecsHelper.SparqlKeywordMD5 + "(" + _expr + ")";
        }
    }
    ...
    public class Sha1HashFunction : BaseHashFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordSha1; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordSha1 + "(" + _expr + ")";
        }
    }
    ...
    public class Sha224HashFunction : BaseHashLibFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordSha224; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordSha224 + "(" + _expr + ")";
        }
    }
    ...
    public class Sha256HashFunction : LeviathanSha256HashFunction
    {
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordSha256 + "(" + _expr + ")";
        }
    }
    ...
    public class Sha384HashFunction : BaseHashFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordSha384; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordSha384 + "(" + _expr + ")";
        }
    }
    ...
    public class Sha512HashFunction : BaseHashFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordSha512; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordSha512 + "(" + _expr + ")";
        }
    }
