...
namespace VDS.RDF.Query.Expressions.Functions
{
    ...
    public class AbsFunction : XPathAbsoluteFunction
    {
        ...
        {
            get { return SparqlSpecsHelper.SparqlKeywordAbs; }
        }
    ...
    public class CeilFunction : XPathCeilingFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordCeil; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordCeil + "(" + _expr + ")";
        }
    }
    ...
    public class FloorFunction : XPathFloorFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordFloor; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordFloor + "(" + _expr + ")";
        }
    }
    ...
    public class RandFunction : BaseArithmeticExpression
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordRand; }
        }
    ...
    public class RoundFunction : XPathRoundFunction
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordRound; }
        }
        ...
        public override string ToString()
        {
            return SparqlSpecsHelper.SparqlKeywordRound + "(" + _expr + ")";
        }
    }
    ...
    public class IsNumericFunction : BaseUnaryExpression
    {
        ...
        public override string Functor
        {
            get { return SparqlSpecsHelper.SparqlKeywordIsNumeric; }
        }
