...
namespace VDS.RDF.Query.Expressions.Functions
{
    ...
    public class XPathYearFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.YearFromDateTime; }
        }
    ...
    public class XPathMonthFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        public override string Functor
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.MonthFromDateTime; }
        }
    ...
    public class XPathDayFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        public override string Functor
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.DayFromDateTime; }
        }
    ...
    public class XPathHoursFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        public override string Functor
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.HoursFromDateTime; }
        }
    ...
    public class XPathMinutesFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        public override string Functor
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.MinutesFromDateTime; }
        }
    ...
    public class XPathSecondsFromDateTimeFunction : BaseUnaryXPathDateTimeFunction
    {
        ...
        public override string Functor
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.SecondsFromDateTime; }
        }
    ...
    public class XPathTimezoneFromDateTimeFunction : ISparqlExpression
    {
                        ...
                        if (lit.DataType.ToString().Equals(XmlSpecsHelper.XmlSchemaDataTypeDateTime))
                        {
                            ...
                            if (DateTimeOffset.TryParse(lit.Value, out dt))
                            {
                                ...
                                if (dt.Offset.Equals(TimeSpan.Zero))
                                {
                                    ...
                                    return new LiteralNode(null, "PT0S",
                                                           new Uri(XmlSpecsHelper.XmlSchemaDataTypeDayTimeDuration));
                                }
                                ...
                                return new LiteralNode(null, offset,
                                                       new Uri(XmlSpecsHelper.XmlSchemaDataTypeDayTimeDuration));
                            }
                            throw new RdfQueryException(
                                "Unable to evaluate an XPath Date Time function as the value of the Date Time typed literal couldn't be parsed as a Date Time");
        ...
        {
            get { return XPathFunctionFactory.XPathFunctionsNamespace + XPathFunctionFactory.TimezoneFromDateTime; }
        }
