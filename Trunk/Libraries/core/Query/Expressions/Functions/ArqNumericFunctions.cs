...
namespace VDS.RDF.Query.Expressions.Functions
{
    ...
    public class ArqMaxFunction : BaseBinaryArithmeticExpression
    {
        ...
        {
            get { return ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.Max; }
        }
        ...
        {
            if (_leftExpr is ISparqlNumericExpression && _rightExpr is ISparqlNumericExpression)
            {
                ISparqlNumericExpression a, b;
                a = (ISparqlNumericExpression) _leftExpr;
                b = (ISparqlNumericExpression) _rightExpr;

                SparqlNumericType type =
                    (SparqlNumericType)
                    Math.Max((int) a.NumericType(context, bindingID), (int) b.NumericType(context, bindingID));
                ...
                switch (type)
                {
                    ...
                    default:
                        throw new RdfQueryException(
                            "Cannot evalute an Arithmetic Expression when the Numeric Type of the expression cannot be determined");
                }
            }
            throw new RdfQueryException(
        ...
        {
            return "<" + ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.Max + ">(" + _leftExpr + ", " +
                   _rightExpr + ")";
        }

        public override ISparqlExpression Transform(IExpressionTransformer transformer)
        {
            return new ArqMaxFunction(transformer.Transform(_leftExpr), transformer.Transform(_rightExpr));
        }
    }
    ...
    public class ArqMinFunction : BaseBinaryArithmeticExpression
    {
        ...
        public override string Functor
        {
            get { return ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.Min; }
        }
        ...
        public override string ToString()
        {
            return "<" + ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.Min + ">(" + _leftExpr + ", " +
                   _rightExpr + ")";
        }

        public override ISparqlExpression Transform(IExpressionTransformer transformer)
        {
            return new ArqMinFunction(transformer.Transform(_leftExpr), transformer.Transform(_rightExpr));
        }
    }
    ...
    public class ArqPiFunction : NumericExpressionTerm
    {
        ...
        public override string Functor
        {
            get { return ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.Pi; }
        }
    ...
    public class ArqEFunction : NumericExpressionTerm
    {
        ...
        public override string Functor
        {
            get { return ArqFunctionFactory.ArqFunctionsNamespace + ArqFunctionFactory.E; }
        }
